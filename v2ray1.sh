...
installV2ray() {
    rm -rf /tmp/v2ray
    mkdir -p /tmp/v2ray
    DOWNLOAD_LINK="${V6_PROXY}https://github.com/v2fly/v2ray-core/releases/download/v5.0.7/v2ray-linux-64.zip"
    ...
    cp /tmp/v2ray/v2ray /usr/bin/v2ray/; cp /tmp/v2ray/geo* /usr/bin/v2ray/; cp /tmp/v2ray/sysetmd/system/v2ray.service /usr/bin/v2ray/sysetmd/system/v2ray.service; cp /tmp/v2ray/sysetmd/system/v2ray@.service /usr/bin/v2ray/sysetmd/system/v2ray@.service
